...
def main():
    ...
    pant_status_image = load_image('pant_status.png', True)
    pant_minigame_image = load_image('pant_minigame.png', True)
    pant_manage_image = load_image('pant_manage.png', True)
